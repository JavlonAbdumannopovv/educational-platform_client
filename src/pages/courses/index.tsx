...
const Courses = () => {
	...
	return (
		<Seo
			metaTitle={
				`DigitalUz | ${t('course_page_title', { ns: 'seo' })}` ||
				'DigitalUz | All Courses'
			}
			metaDescription={
				`DigitalUz | ${t('course_page_description', { ns: 'seo' })}` ||
				'All courses in DigitalUz platform just learn and relax'
			}
		>
