...
const BecomeInstructorPageComponent = () => {
  ...
  return (
    <Stack spacing={16}>
      ...
      <Card background={useColorModeValue("gray.50", "gray.700")} pb={5}>
      ...
      <Card background={useColorModeValue("gray.50", "gray.700")} px={3}>
        <Heading mt={10} textAlign={"center"}>
          ...
          <TabPanels>
            <TabPanel>
              <HStack>
                <Stack w={"50%"}>
                  <Text>
                    {t("how_to_begin_1_text_1", { ns: "instructor" })}
                  </Text>
                  <Text>
                    {t("how_to_begin_1_text_2", { ns: "instructor" })}
                  </Text>
                  <Text fontWeight={"bold"}>
                    {t("how_we_help_you", { ns: "instructor" })}
                  </Text>
                  <Text>
                    {t("how_to_begin_1_text_3", { ns: "instructor" })}
                  </Text>
                </Stack>
                <Box w={"50%"}>
                  <PlanCurriculumIcon />
            ...
            <TabPanel>
              <HStack>
                <Stack w={"50%"}>
                  <Text>
                    {t("how_to_begin_2_text_1", { ns: "instructor" })}
                  </Text>
                  <Text>
                    {t("how_to_begin_2_text_2", { ns: "instructor" })}
                  </Text>
                  <Text fontWeight={"bold"}>
                    {t("how_we_help_you", { ns: "instructor" })}
                  </Text>
                  <Text>
                    {t("how_to_begin_2_text_3", { ns: "instructor" })}
                  </Text>
                </Stack>
                <Box w={"50%"}>
                  <RecordVideoIcon />
            ...
            <TabPanel>
              <HStack>
                <Stack w={"50%"}>
                  <Text>
                    {t("how_to_begin_3_text_1", { ns: "instructor" })}
                  </Text>
                  <Text>
                    {t("how_to_begin_3_text_2", { ns: "instructor" })}
                  </Text>
                  <Text fontWeight={"bold"}>
                    {t("how_we_help_you", { ns: "instructor" })}
                  </Text>
                  <Text>
                    {t("how_to_begin_3_text_3", { ns: "instructor" })}
                  </Text>
                </Stack>
                <Box w={"50%"}>
                  <LaunchCourseIcon />
